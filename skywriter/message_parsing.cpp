...
BaseReceivedMessage::BaseReceivedMessage(uint8_t size, uint8_t sequence, uint8_t id) :
	Size{size},
	Sequence{sequence},
	ID{id}
{
...
SensorOutput::SensorOutput(uint8_t size, uint8_t sequence, uint8_t id) :
	BaseReceivedMessage(size, sequence, id)
{
